...
def train(args, teacher_network):
    ...
    with g1.as_default():
        ...
        c = args.temperature ** 3
        loss = c * tf.losses.softmax_cross_entropy(target_label_onehot, logits/args.temperature) + tf.losses.softmax_cross_entropy(label_onehot, logits) + loss_reg
